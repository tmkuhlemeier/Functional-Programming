...
/* package pacmannn-0.1.0.0 */
#ifndef VERSION_pacmannn
#define VERSION_pacmannn "0.1.0.0"
#endif /* VERSION_pacmannn */
#ifndef MIN_VERSION_pacmannn
#define MIN_VERSION_pacmannn(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pacmannn */
...
#define CURRENT_COMPONENT_ID "pacmannn-0.1.0.0-inplace-pacmannn"
